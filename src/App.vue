  ...
  <main class="app">
    ...
    <section class="panel">
      ...
      <div class="settings">
        ...
        <fieldset class="settings-group">
          ...
          <div class="settings-grid">
            ...
            <div class="field">
              <span>语音引擎</span>
              <span class="engine-chip" :data-status="engineStatus">{{ engineStatusLabel }}</span>
            </div>
          </div>
        </fieldset>
      </div>
      ...
      <div class="actions">
        ...
        <button type="button" :disabled="!currentItem" @click="repeatCurrent">重复发音（空格）</button>
