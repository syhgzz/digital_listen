...
<template>
  <main class="app">
    ...
    <section class="panel">
      <nav class="tabs" role="tablist" aria-label="训练模块">
        <button
      ...
      <section class="settings-block" aria-label="语音设置">
        <h2 class="block-title">语音设置</h2>
      ...
      <section class="settings-block" aria-label="模块参数">
        <h2 class="block-title">模块参数 · {{ moduleLabels[activeModule] }}</h2>
        <div class="settings-grid">
      ...
      <section class="practice-area" aria-label="答题区">
        ...
        <div class="actions">
          ...
          <button type="button" :disabled="!currentItem" @click="repeatCurrent">
            重复发音（空格）
          </button>
